...
def enchant_soulshard_dagger() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Soulshard Dagger", "damage_type": "Arcane/Piercing", "base_damage": random.randint(9, 25),
...
def hone_refactoring_sickle() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Refactoring Sickle", "damage_type": "Cleansing", "base_damage": random.randint(10, 30),
...
def fire_quickstart_crossbow() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Quickstart Crossbow", "damage_type": "Initiative", "base_damage": random.randint(10, 30),
...
def wield_daggers_of_pair_programming() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Daggers of Pair Programming", "damage_type": "Collaborative", "base_damage": random.randint(10, 30),
...
def craft_granite_maul() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Granite Maul", "damage_type": "Bludgeoning", "base_damage": random.randint(10, 30),
...
def focus_lens_of_clarity() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Lens of Clarity", "damage_type": "Revelation", "base_damage": random.randint(10, 30), "critical_hit_chance": 1.0,
...
def scribe_with_codex_of_openapi() -> dict[str, Any]:
    ...
    return {
        "weapon_name": "Codex of OpenAPI", "damage_type": "Documentation", "base_damage": random.randint(10, 30),
